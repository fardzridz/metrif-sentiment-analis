...
7. Mengevaluasi performa model menggunakan accuracy dan F1-score.
8. Menyimpan model terbaik.
9. Menampilkan hasil analisis dan fitur prediksi melalui dashboard.
...
Pembagian data dilakukan dengan mempertahankan proporsi kelas sentimen agar distribusi label positif, netral, dan negatif tetap seimbang antara data training dan testing. Pendekatan ini membantu evaluasi model menjadi lebih adil.
...
Setiap model dilatih menggunakan fitur TF-IDF dan label sentimen. Setelah proses training selesai, model dievaluasi menggunakan accuracy dan F1-score. Model dengan performa terbaik kemudian disimpan sebagai model utama untuk fitur prediksi.
...
Dashboard ini dirancang agar pengguna dapat melihat hasil analisis tanpa harus menjalankan kode secara manual.
